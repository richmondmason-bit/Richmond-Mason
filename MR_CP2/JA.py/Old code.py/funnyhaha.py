...
print(f"{'Type'} 'quit' {'anytime to stop playing.'}\n")
while True:
    player = input(f"{'Choose rock, paper, or scissors:'} ").strip().lower()
    if player == "quit":
        print(f"\n{'Final Scoreboard:'}")
    ...
    if player not in choices:
        print(f"{'Invalid choice! Please type rock, paper, or scissors.'}\n")
        continue
